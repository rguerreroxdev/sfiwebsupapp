<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.02");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("03.01.02");
        $accesoCrear = in_array("03.01.02.01", $accesos) ? "" : " disabled";
?>

<h3>Referral platforms</h3>
...
<div class="col-lg-9">
    ...
    id="tabledatos"
            data-toggle="table"
            data-url="./mods/facturacion/plataformasref/procs/getplataformas.php"
    ...
    >
        <thead>
            <tr>
                <th data-field="PLATAFORMADEREFERENCIAID" data-visible="false">ID</th>
