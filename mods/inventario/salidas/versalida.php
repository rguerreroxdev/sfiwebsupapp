<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $salidaId = isset($_GET["sid"]) ? $_GET["sid"] : -1;
        ...
        {
            echo ("<script>window.location.href='?mod=inventario&opc=salidas'</script>");
            exit();
        }

        // Obtener accesos a opciones sobre registro
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("02.02.03");
        $accesoEditar = in_array("02.02.03.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("02.02.03.03", $accesos) ? "" : " disabled";
        $accesoCerrar = in_array("02.02.03.04", $accesos) ? "" : " disabled";
        $accesoProcesar = in_array("02.02.03.05", $accesos) ? "" : " disabled";

        $textoCerrarAbrir = "";
        $textoEliminarAnular = "";
        switch (strtoupper($objSalida->estado))
        {
            case 'FOR':
                $accesoProcesar = "disabled";
                $textoCerrarAbrir = "Close";
                $textoEliminarAnular = $objSalida->correlativo == -1 ? "Delete" : "Cancel";
                break;
            case 'CER':
...
<h3>Inventory discharges - Document data</h3>
...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-editar" role="tabpanel" aria-labelledby="nav-editar-tab" tabindex="0">
        <div class="p-3 bg-body rounded shadow-sm">
            ...
            <div class="row">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="correlativo" name="correlativo" class="form-control form-control-sm text-center" value="<?= $objSalida->correlativo ?>" readonly>
                    </div>
                </div>
                <div class="col-sm-1">
                    <!-- vacío -->
                ...
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombredeestado" name="nombredeestado" class="form-control form-control-sm text-center" value="<?= $objSalida->nombreDeEstado ?>" readonly>
                        <input type="hidden" id="estado" name="estado" value="<?= $objSalida->estado ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-7 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="sucursal" name="sucursal" class="form-control form-control-sm" value="<?= $objSalida->sucursal ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-6 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="tipodesalida" name="tipodesalida" class="form-control form-control-sm" value="<?= $objSalida->tipoDeSalida ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Discharge date</span>
                        <input type="text" id="fechadesalida" name="fechadesalida" class="form-control form-control-sm text-center" value="<?= $objSalida->fecha ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-11 col-lg-8">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Concept</span>
                        <textarea id="concepto" name="concepto" class="form-control form-control-sm" maxlength="500" value="" readonly><?= $objSalida->concepto ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-12">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-auto"<?php if ($objSalida->estado == "PRO"): ?> style="display: none;"<?php endif; ?>>
        ...
        <div class="p-3 mt-2 bg-body rounded shadow-sm">
            <div class="col">
                <table
                    id="tabledatos"
                    data-toggle="table"
                    data-url="./mods/inventario/salidas/procs/getsalidadetalle.php?sid=<?= $objSalida->salidaId ?>"
                ...
                >
                    <thead>
                        ...
                        <th data-field="Index" data-formatter="rowIndexFormatter">#</th>
                            ...
                            <th data-field="TIPODESTOCKORIGEN" data-width="80">Stock type orig.</th>
                            <th data-field="COSTOORIGEN" data-width="80" data-align="right" data-formatter="costOFormatter">Cost orig.</th>
                            <th data-field="TIPODESTOCK" data-width="80">Stock type distr.</th>
                            <th data-field="COSTODIST" data-width="80" data-align="right" data-formatter="costDFormatter">Cost distr.</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Registros -->
        ...
        <input type="hidden" id="sid" name="sid" value="<?= $objSalida->salidaId ?>">
        <input type="hidden" id="estadoActual" name="estadoActual" value="<?= $objSalida->estado ?>">
    </div>
    ...
    <div class="tab-pane fade" id="nav-historial" role="tabpanel" aria-labelledby="nav-historial-tab" tabindex="0">
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objSalida->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objSalida->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objSalida->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objSalida->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-3 mt-2 bg-body rounded shadow-sm">
            <table
                id="tabledatos"
                data-toggle="table"
                data-url="./mods/inventario/salidas/procs/getsalidaestados.php?sid=<?= $objSalida->salidaId ?>"
                class="table-sm small"
            >
                <thead>
                    <tr>
                        <th data-field="SALIDAESTADOID" data-visible="false">ID</th>
                        <th data-field="SALIDAID" data-visible="false">RID</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?= $objSalida->estado == "FOR" ? "<br>A closed document can not be edited." : "" ?>
            </div>
            <div class="modal-footer">
