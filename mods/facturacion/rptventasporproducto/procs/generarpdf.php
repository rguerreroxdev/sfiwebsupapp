...
class PDF extends TCPDF
{
    ...
    function Header()
    {
        ...
        $this->SetXY(15, 20);	$this->Cell(0, 5, "SALES BY PRODUCT", 0, 0, "C");
        ...
        $this->SetXY($x +=  7, $y);     $this->Cell(40, 5, 'Product', 1, 0, '', false);
...
{
    $filaConteo++;
    $totalVentas += $fila["SUMADEPRECIOS"];
...
$pdf->Output("Sales by product.pdf");
