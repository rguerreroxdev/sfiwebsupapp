<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.04.03");
    ...
    <div class="row">
        ...
        <div class="col-auto">
            <div class="input-group input-group-sm width-290px">
                <label class="input-group-text" for="dias">Days greater than or equal to</label>
                <input type="text" id="dias" name="dias" class="form-control form-control-sm" value="0" oninput="limitarDigitos(this)" maxlength="4">
            </div>
        </div>
    </div>
    <div class="row mt-3">
