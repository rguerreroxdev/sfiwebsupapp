...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=clientes&subopc=vercliente&cid=" + document.getElementById("cid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/facturacion/clientes/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
