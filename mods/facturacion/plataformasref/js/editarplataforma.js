...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=plataformasref&subopc=verplataforma&prid=" + document.getElementById("prid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/facturacion/plataformasref/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
