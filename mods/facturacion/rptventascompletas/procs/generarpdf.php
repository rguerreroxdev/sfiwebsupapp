...
class PDF extends TCPDF
{
    ...
    function Header()
    {
        ...
        $this->SetXY(15, 20);	$this->Cell(0, 5, "COMPLETE SALES", 0, 0, "C");
        ...
        $this->SetXY($x += 15, $y);     $this->Cell(15, 5, 'Invoice #', 1, 0, '', false);
        $this->SetXY($x += 15, $y);     $this->Cell(40, 5, 'Customer name', 1, 0, '', false);
        $this->SetXY($x += 40, $y);     $this->Cell(30, 5, 'Product', 1, 0, '', false);
        $this->SetXY($x += 30, $y);     $this->Cell(20, 5, 'Price', 1, 0, '', false);
        $this->SetXY($x += 20, $y);     $this->Cell(28, 5, 'Platform', 1, 0, '', false);
        $this->SetXY($x += 28, $y);     $this->Cell(40, 5, 'Referral person', 1, 0, '', false);
        $this->SetXY($x += 40, $y);     $this->Cell(40, 5, 'Salesperson', 1, 0, '', false);
...
$anchoDeColumnas = [7, 15, 15, 40, 30, 20, 28, 40, 40];
$alineacionDeCelda = ["L", "L", "L", "L", "L", "R", "L", "L", "L"];
...
// Mostrar área de total de ítems y total de precios
$currentY += 20;
...
$pdf->setXY(92, $currentY - 20); $pdf->Cell(30, 5, "Total: ", 0, 0, "R");
$pdf->setXY(122, $currentY - 20); $pdf->Cell(20, 5, "$ " . number_format($totalPrecios, 2, ".", ","), 1, 0, "R");

//-----------------------------------------------

// Generar el PDF y enviarlo al navegador
$pdf->Output("Complete sales.pdf");
