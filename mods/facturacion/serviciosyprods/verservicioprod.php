<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $objServicioProd->getById($servicioProductoId);

        // Si el registro no existe, retornar a listado
        if ($objServicioProd->otroServicioProductoId == -1)
        {
        ...
        $accesoEditar = in_array("03.01.05.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("03.01.05.03", $accesos) ? "" : " disabled";
?>

<h3>Services and other products - Service/Product data</h3>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigo" name="codigo" class="form-control form-control-sm" value="<?= $objServicioProd->codigo ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="descripcion" name="descripcion" class="form-control form-control-sm" value="<?= $objServicioProd->descripcion ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="marca" name="marca" class="form-control form-control-sm" value="<?= $objServicioProd->marca ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="modelo" name="modelo" class="form-control form-control-sm" value="<?= $objServicioProd->modelo ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objServicioProd->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objServicioProd->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objServicioProd->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objServicioProd->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>

        <input type="hidden" id="spid" name="spid" value="<?= $objServicioProd->otroServicioProductoId ?>">
