...
document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=tiposdestock&subopc=editartipodestock&tsid=" + document.getElementById("tsid").value;
});
...
function eliminar()
{
    ...
    datos.append("tsid", document.getElementById("tsid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/inventario/tiposdestock/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
