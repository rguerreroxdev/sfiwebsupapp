...
function generarPdf()
{
    ...
    let url = `mods/facturacion/rptventasporplataforma/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = `mods/facturacion/rptventasporplataforma/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
