...
document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=configuracion&subopc=editarconfiguracion&csid=" + document.getElementById("csid").value;
});
...
function eliminar()
{
    ...
    datos.append("csid", document.getElementById("csid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/facturacion/configuracion/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
