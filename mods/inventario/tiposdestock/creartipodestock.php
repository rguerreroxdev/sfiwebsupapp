<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.01.06.01");
            ...
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigoproveedor" name="codigoproveedor" class="form-control form-control-sm" style="max-width: 70px;" oninput="buscarProveedor(event)" style="max-width: 70px;" maxlength="4" value="" required>
                        <input type="text" id="proveedor" name="proveedor" class="form-control form-control-sm" value="" readonly>
            ...
            <div class="row mt-2">
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombrecorto" name="nombrecorto" class="form-control form-control-sm" maxlength="15" value="" required>
                    </div>
                </div>
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-95px">Percentage<span class="text-danger">&nbsp;*</span></span>
                        <input type="number" id="porcentaje" name="porcentaje" class="form-control form-control-sm text-end" step="0.01" min="0.00" max="100.00" value="" required>
                    </div>
                </div>
            </div>
        </div>
