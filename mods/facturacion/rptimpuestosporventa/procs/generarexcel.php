...
array_push($data, [
    "<b>#</b>", "<b>Date</b>", "<b>Taxes to declare</b>", "<b>Financed taxes</b>"
]);
...
{
    $conteo++;
    $totalPorDeclarar += $dato["SUMAIMPUESTOPORDECLARAR"];
    $totalNoDeclarar += $dato["SUMAIMPUESTOSINDECLARAR"];

    array_push($data, [
        $conteo,
        str_replace("/", "-", $dato["FECHA"]),
        number_format($dato["SUMAIMPUESTOPORDECLARAR"], 2, ".", ""),
        number_format($dato["SUMAIMPUESTOSINDECLARAR"], 2, ".", "")
    ]);
}
