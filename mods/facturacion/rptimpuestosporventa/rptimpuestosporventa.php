<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.04.07");
    ...
    <div class="row mt-3">
        <div class="col-auto">
            <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="mostrardetalle">Show detailed taxes</label>
            </div>
        </div>
    </div>
