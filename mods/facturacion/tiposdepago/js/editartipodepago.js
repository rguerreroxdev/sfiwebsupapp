...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=tiposdepago&subopc=vertipodepago&tpid=" + document.getElementById("tpid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/facturacion/tiposdepago/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
