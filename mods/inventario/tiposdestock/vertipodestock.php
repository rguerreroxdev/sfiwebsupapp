<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.01.06");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("02.01.06");
        $accesoEditar = in_array("02.01.06.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("02.01.06.03", $accesos) ? "" : " disabled";
?>

<h3>Stock Types - Stock Type data</h3>
        ...
        <div class="p-3 bg-body rounded shadow-sm">
            <div class="row">
                <div class="col-md-8 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigoproveedor" name="codigoproveedor" class="form-control form-control-sm" style="max-width: 70px;" value="<?= $objTiposDeStock->codigoProveedor ?>" readonly>
            ...
            <div class="row mt-2">
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Short name</span>
                        <input type="text" id="nombrecorto" name="nombrecorto" class="form-control form-control-sm" value="<?= $objTiposDeStock->nombreCorto ?>" readonly>
                    </div>
                </div>
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Percentage</span>
                        <input type="text" id="porcentaje" name="porcentaje" class="form-control form-control-sm text-end" value="<?= number_format($objTiposDeStock->porcentaje, 2) ?> %" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objTiposDeStock->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objTiposDeStock->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
