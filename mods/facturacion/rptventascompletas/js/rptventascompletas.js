...
function generarPdf()
{
    ...
    let url = `mods/facturacion/rptventascompletas/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = `mods/facturacion/rptventascompletas/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
