<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("01.02.02.01", $accesos) ? "" : " disabled";
?>
...
<div class="col-lg-9">
    ...
    id="tabledatos"
            data-toggle="table"
            data-url="./mods/admin/perfiles/procs/getperfiles.php"
    ...
    >
        <thead>
            <tr>
                <th data-field="PERFILID" data-visible="false">ID</th>
                <th data-field="Index" data-formatter="rowIndexFormatter">#</th>
                <th data-field="NOMBRE">Profile name</th>
