...
document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=clientes&subopc=editarcliente&cid=" + document.getElementById("cid").value;
});
...
function eliminar()
{
    ...
    fetch(
        "./mods/facturacion/clientes/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
