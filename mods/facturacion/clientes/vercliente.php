<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.01");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("03.01.01");
        $accesoEditar = in_array("03.01.01.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("03.01.01.03", $accesos) ? "" : " disabled";
?>

<h3>Customers - Customer data</h3>
        ...
        <div class="p-3 bg-body rounded shadow-sm">
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-95px">Name</span>
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" value="<?= $objClientes->nombre ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" value="<?= $objClientes->direccion ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccioncomplemento" name="direccioncomplemento" class="form-control form-control-sm" value="<?= $objClientes->direccionComplemento ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigopostal" name="codigopostal" class="form-control form-control-sm" value="<?= $objClientes->codigoPostal ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" value="<?= $objClientes->telefono ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="email" id="correoelectronico" name="correoelectronico" class="form-control form-control-sm" value="<?= $objClientes->correoElectronico ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objClientes->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objClientes->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
