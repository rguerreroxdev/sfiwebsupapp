<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.02.01");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("03.02.01.01", $accesos) ? "" : " disabled";
...
<h3>Invoice numbering and tax</h3>
...
<div class="col-lg-10">
    ...
    <table
            id="tabledatos"
            data-toggle="table"
            data-url="./mods/facturacion/configuracion/procs/getconfiguraciones.php"
    ...
    >
        <thead>
            <tr>
                <th data-field="CONFIGURACIONPORSUCURSALID" data-visible="false">ID</th>
