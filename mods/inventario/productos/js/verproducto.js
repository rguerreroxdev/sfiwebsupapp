...
document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=productos&subopc=editarproducto&pid=" + document.getElementById("pid").value;
});
...
function eliminar()
{
    ...
    fetch(
        "./mods/inventario/productos/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
