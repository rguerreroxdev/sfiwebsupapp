<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("ADM", "01.01.02.01");
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" maxlength="200" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-text">
                            <input type="checkbox" id="escasamatriz" name="escasamatriz" class="form-check-input mt-0" value="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" maxlength="100">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccioncomplemento" name="direccioncomplemento" class="form-control form-control-sm" maxlength="100">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigopostal" name="codigopostal" class="form-control form-control-sm" minlength="5" maxlength="5">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" maxlength="50">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefonoservicio" name="telefonoservicio" class="form-control form-control-sm" maxlength="50">
                    </div>
                </div>
            </div>
        </div>
