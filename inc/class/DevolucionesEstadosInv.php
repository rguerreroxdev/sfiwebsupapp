...
class DevolucionesEstadosInv
{
    ...
    /**
     * Instancia un objeto DevolucionesEstadosInv
     * 
    ...
    /**
     * Obtener todos los registros de la tabla (INVDEVOLUCIONESESTADOS) con paginación
     * 
        ...
        $sentenciaSql = "
            SELECT
                ...
                ,CASE
                    ...
                    WHEN DE.ESTADO = 'ANU' THEN 'CANCELED'
                END AS NOMBREDEESTADO
                ,DE.DESCRIPCION
                ,DE.USUARIOID
                ,U.USUARIO
            FROM
                INVDEVOLUCIONESESTADOS DE
    ...
    /**
     * Agregar un nuevo registro (INVDEVOLUCIONESESTADOS)
     * 
