<?php
    ...
    {   // Se cierra al final del archivo
        ...
        // Obtener los datos del producto recibido en la URL
        $productoId = -1;
        if (isset($_GET["pid"]))
        {
            $productoId = is_numeric($_GET["pid"]) ? intval($_GET["pid"]) : -1;
        }
        
        require_once("inc/class/Productos.php");
        $objProductos = new Productos($conn);

        $objProductos->getById($productoId);

        // Si el registro no existe, retornar a listado
        if ($objProductos->productoId == -1)
        {
            echo ("<script>window.location.href='?mod=inventario&opc=productos'</script>");
            exit();
        }

        // Obtener accesos a opciones sobre registro
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("02.01.01");
        $accesoEditar = in_array("02.01.01.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("02.01.01.03", $accesos) ? "" : " disabled";
?>

<h3>Products - Product data</h3>
    ...
    <div class="tab-pane fade show active" id="nav-editar" role="tabpanel" aria-labelledby="nav-editar-tab" tabindex="0">
        <div class="p-3 bg-body rounded shadow-sm">
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigo" name="codigo" class="form-control form-control-sm" value="<?= $objProductos->codigo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Category</span>
                        <input type="text" id="categoria" name="categoria" class="form-control form-control-sm" value="<?= $objProductos->categoria ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Brand</span>
                        <input type="text" id="marca" name="marca" class="form-control form-control-sm" value="<?= $objProductos->marca ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Model</span>
                        <input type="text" id="modelo" name="modelo" class="form-control form-control-sm" value="<?= $objProductos->modelo ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Color</span>
                        <input type="text" id="color" name="color" class="form-control form-control-sm" value="<?= $objProductos->color ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-90px">Description</span>
                        <input type="text" id="descripcion" name="descripcion" class="form-control form-control-sm" value="<?= $objProductos->descripcion ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="msrp" name="msrp" class="form-control form-control-sm text-end" value="$ <?= number_format($objProductos->msrp, 2) ?>" readonly>
                        </div>
                    </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objProductos->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objProductos->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objProductos->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objProductos->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>

        <input type="hidden" id="pid" name="pid" value="<?= $objProductos->productoId ?>">
