<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.04");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("03.01.04.01", $accesos) ? "" : " disabled";
?>
...
<div class="col-lg-9">
    ...
    id="tabledatos"
            data-toggle="table"
            data-url="./mods/facturacion/tiposdepago/procs/gettiposdepago.php"
    ...
    >
        <thead>
            <tr>
                <th data-field="TIPODEPAGOID" data-visible="false">ID</th>
                <th data-field="Index" data-formatter="rowIndexFormatter">#</th>
                <th data-field="NOMBRE">Name</th>
                <th data-field="SUMAIMPUESTO" data-align="center" data-formatter="sumaImpuestoFormatter" data-width="150">Add tax to reports</th>
                <th data-field="PERMITEPAGOSINIMPUESTO" data-align="center" data-formatter="pagoSinImpuestoFormatter" data-width="150">Cand add payments without tax</th>
