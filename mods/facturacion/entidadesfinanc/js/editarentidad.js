...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=entidadesfinanc&subopc=verentidad&efid=" + document.getElementById("efid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/facturacion/entidadesfinanc/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
