...
$tipoDeSalidaId = isset($_GET["tsid"]) && trim($_GET["tsid"]) != "" ? $_GET["tsid"] : -1;
...
$listaDeSalidas = $objSalidas->getAllSucursalXUsuarioConPaginacion($usuarioId, $sucursalId, $tipoDeSalidaId, $correlativo, $fechaDesde, $estado, $numeroDePagina, $tamanoDePagina);

$resultado = $listaDeSalidas;
