<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.03.02");
...
<h3>Financial entities - Edit data</h3>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" value="<?= $objEntidadFinanciera->nombre ?>" maxlength="200" required>
                    </div>
                </div>
            </div>
        </div>
