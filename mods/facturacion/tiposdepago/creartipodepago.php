<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.04.01");
...
<h3>Forms of payment - Create new</h3>
            ...
            <div class="row">
                <div class="col-sm-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" maxlength="100" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-text">
                            <input type="checkbox" id="sumaimpuesto" name="sumaimpuesto" class="form-check-input mt-0" value="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-sm-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-text">
                            <input type="checkbox" id="pagosinimpuesto" name="pagosinimpuesto" class="form-check-input mt-0" value=""> 
                        </div>
                    </div>
                </div>
            </div>
