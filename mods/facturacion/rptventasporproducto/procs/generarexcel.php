...
$datos = $objReportes->ventasAgrupadasPorProducto($fechaInicial, $fechaFinal, $sucursalId);
...
array_push($data, ["<b>Sales by product</b>"]);
...
array_push($data, [
    "<b>#</b>", "<b>Product</b>", "<b>Quantity of products</b>", "<b>Sum of sales</b>"
]);
...
array_push($data, [
    "", "",
    "Total:", number_format($ventaTotal, 2, ".", "")
]);
...
$xlsx->downloadAs('Sales by products.xlsx');