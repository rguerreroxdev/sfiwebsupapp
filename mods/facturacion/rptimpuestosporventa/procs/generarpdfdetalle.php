...
class PDF extends TCPDF
{
    ...
    function Header()
    {
        ...
        $this->SetXY(15, 20);	$this->Cell(0, 5, "SALES TAXES", 0, 0, "C");
        ...
        $this->SetXY($x +=  7, $y);     $this->Cell(30, 5, 'Date', 1, 0, '', false);
        $this->SetXY($x += 30, $y);     $this->Cell(30, 5, 'Invoice #', 1, 0, '', false);
        $this->SetXY($x += 30, $y);     $this->Cell(30, 5, 'Form of payment', 1, 0, '', false);
        $this->SetXY($x += 30, $y);     $this->Cell(30, 5, 'Taxes to declare', 1, 0, '', false);
        $this->SetXY($x += 30, $y);     $this->Cell(30, 5, 'Financed taxes', 1, 0, '', false);
...
$datos = $objReportes->detalleDeImpuestosPorDeclarar($fechaInicial, $fechaFinal, $sucursalId);
...
{
    $filaConteo++;
    $totalPorDeclarar += $fila["IMPUESTOPORDECLARAR"];
    $totalNoDeclarar += $fila["IMPUESTOSINDECLARAR"];
    ...
    $arrayFila = [
        ...
        $fila["CORRELATIVO"],
        $fila["TIPODEPAGO"],
        "$ " . number_format($fila["IMPUESTOPORDECLARAR"], 2, ".", ","),
        "$ " . number_format($fila["IMPUESTOSINDECLARAR"], 2, ".", ",")
    ];
...
$anchoDeColumnas = [7, 30, 30, 30, 30, 30];
$alineacionDeCelda = ["L", "L", "L", "L", "R", "R"];
...
$pdf->setXY(82, $currentY - 20); $pdf->Cell(30, 5, "Total: ", 0, 0, "R");
$pdf->setXY(112, $currentY - 20); $pdf->Cell(30, 5, "$ " . number_format($totalPorDeclarar, 2, ".", ","), 1, 0, "R");
$pdf->setXY(142, $currentY - 20); $pdf->Cell(30, 5, "$ " . number_format($totalNoDeclarar, 2, ".", ","), 1, 0, "R");

//-----------------------------------------------

// Generar el PDF y enviarlo al navegador
$pdf->Output("Sales taxes.pdf");
