...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=proveedores";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=proveedores&subopc=editarproveedor&pid=" + document.getElementById("pid").value;
});
...
function eliminar()
{
    ...
    fetch(
        "./mods/inventario/proveedores/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
