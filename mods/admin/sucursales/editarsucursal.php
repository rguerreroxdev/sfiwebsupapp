<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("ADM", "01.01.02.02");
...
<div class="tab-content" id="nav-tabContent">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Name<span class="text-danger">&nbsp;*</span></span>
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" value="<?= $objSucursal->nombre ?>" maxlength="200" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <div class="input-group-text">
                            <input type="checkbox" id="escasamatriz" name="escasamatriz" class="form-check-input mt-0" value=""<?= $objSucursal->esCasaMatriz == 1 ? " checked" : "" ?>>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" maxlength="100" value="<?= $objSucursal->direccion ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccioncomplemento" name="direccioncomplemento" class="form-control form-control-sm" maxlength="100" value="<?= $objSucursal->direccionComplemento ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigopostal" name="codigopostal" class="form-control form-control-sm" minlength="5" maxlength="5" value="<?= $objSucursal->codigoPostal ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" maxlength="50" value="<?= $objSucursal->telefono ?>">
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefonoservicio" name="telefonoservicio" class="form-control form-control-sm" maxlength="50" value="<?= $objSucursal->telefonoServicio ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="tab-pane fade" id="nav-historial" role="tabpanel" aria-labelledby="nav-historial-tab" tabindex="0">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objSucursal->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objSucursal->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
        ...
        <input type="hidden" id="sid" name="sid" value="<?= $objSucursal->sucursalId ?>">
