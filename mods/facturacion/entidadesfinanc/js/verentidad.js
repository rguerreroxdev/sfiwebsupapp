...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=entidadesfinanc";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=entidadesfinanc&subopc=editarentidad&efid=" + document.getElementById("efid").value;
});
...
function eliminar()
{
    ...
    datos.append("efid", document.getElementById("efid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/facturacion/entidadesfinanc/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
