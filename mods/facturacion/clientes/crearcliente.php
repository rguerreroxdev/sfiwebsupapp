<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.01.01");
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="email" id="correoelectronico" name="correoelectronico" class="form-control form-control-sm" maxlength="100">
                    </div>
                </div>
            </div>
        </div>
