<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.01.02.02");
            ...
            <div class="row mt-2">
                <div class="col-md-7 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" maxlength="200" value="<?= $objProveedores->nombre ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-7 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" maxlength="200" value="<?= $objProveedores->direccion ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" maxlength="50" value="<?= $objProveedores->telefono ?>">
                    </div>
                </div>
            </div>
        </div>
