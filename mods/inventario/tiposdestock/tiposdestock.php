<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("02.01.06.01", $accesos) ? "" : " disabled";
?>
...
<div class="col-lg-9">
    ...
    <table
            id="tabledatos"
            data-toggle="table"
            data-url="./mods/inventario/tiposdestock/procs/gettiposdestock.php"
    ...
    >
        <thead>
            <tr>
                ...
                <th data-field="PORCENTAJE" data-align="right" data-formatter="porcentajeFormatter">Percentage</th>
