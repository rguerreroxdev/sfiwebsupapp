<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("03.03.02.01", $accesos) ? "" : " disabled";
...
<table
        ...
        data-url="./mods/facturacion/devoluciones/procs/getdevoluciones.php"
...
>
    <thead>
        <tr>
            ...
            <th data-field="NUMERODEVOLUCION">Correlative</th>
            ...
            <th data-field="NUMEROFACTURADEVUELTA">Returned invoice</th>
            <th data-field="NUMEROFACTURASUSTITUYE">Substitute invoice</th>
