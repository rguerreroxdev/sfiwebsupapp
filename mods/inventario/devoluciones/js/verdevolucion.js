...
document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=devoluciones&subopc=registrodevolucion&did=" + document.getElementById("did").value;
});
...
function eliminar()
{
    ...
    fetch(
        "./mods/inventario/devoluciones/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
...
function cambiarEstado(estado)
{
    ...
    fetch(
        "./mods/inventario/devoluciones/procs/cambiarestado.php",
        {
            method: "POST",
            body: datos
        }
...
function finalizar(data, accion)
{
    ...
    {
        let mensaje = "";
        let url = "?mod=inventario&opc=devoluciones&subopc=verdevolucion&did=" + document.getElementById("did").value;
        switch (accion) {
            case "eliminar":
                mensaje = "The document was deleted.";
                url = "?mod=inventario&opc=devoluciones"
                break;
...
{
    let url = 'mods/inventario/devoluciones/procs/imprimirdevolucion.php?did=' + document.getElementById("did").value;
    window.open(url, "_blank");
}

function generarExcel()
{
    let url = 'mods/inventario/devoluciones/procs/generarexcel.php?did=' + document.getElementById("did").value;
    window.open(url, "_blank");
}
