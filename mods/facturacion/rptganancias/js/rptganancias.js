...
function generarPdf()
{
    ...
    let url = mostrarDetalle ?
        `mods/facturacion/rptganancias/procs/generarpdfdetalle.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`
        :
        `mods/facturacion/rptganancias/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = mostrarDetalle ?
        `mods/facturacion/rptganancias/procs/generarexceldetalle.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`
        :
        `mods/facturacion/rptganancias/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
