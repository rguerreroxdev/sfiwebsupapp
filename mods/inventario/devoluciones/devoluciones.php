<?php
    ...
    {   // Se cierra al final del archivo
        ...
        $accesoCrear = in_array("02.02.04.01", $accesos) ? "" : " disabled";
...
<table
        ...
        data-url="./mods/inventario/devoluciones/procs/getdevoluciones.php"
...
>
    <thead>
        <tr>
            <th data-field="DEVOLUCIONID" data-visible="false">ID</th>
