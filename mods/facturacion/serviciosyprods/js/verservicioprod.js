...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=serviciosyprods";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=serviciosyprods&subopc=editarservicioprod&spid=" + document.getElementById("spid").value;
});
...
function eliminar()
{
    ...
    datos.append("spid", document.getElementById("spid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/facturacion/serviciosyprods/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
