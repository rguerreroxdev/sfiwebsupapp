...
function generarPdf()
{
    ...
    let url = `mods/facturacion/rptventasporproducto/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = `mods/facturacion/rptventasporproducto/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
