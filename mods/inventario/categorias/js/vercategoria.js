...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=categorias";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=categorias&subopc=editarcategoria&cid=" + document.getElementById("cid").value;
});
...
function eliminar()
{
    ...
    datos.append("cid", document.getElementById("cid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/inventario/categorias/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
