<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.04.02");
...
<h3>Report: Sales by employee</h3>
    ...
    <div class="row mt-3">
        <div class="col-auto">
            <div class="input-group input-group-sm">
                <span class="input-group-text width-100px">Salesperson</span>
                <input type="text" id="vendedor" name="vendedor" class="form-control form-control-sm" readonly>
                <input type="hidden" id="vendedorid" name="vendedorid" class="form-control form-control-sm">
                <button class="btn btn-outline-secondary" type="button" id="btnvendedor"><i class="bi bi-search"></i></button>
            </div>
        </div>
        <div class="col-auto">
            <button type="button" id="btntodos" name="btntodos" class="btn btn-sm btn-primary">All salesperson</button>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-auto">
    ...
    <div class="row mt-3">
        <div class="col-auto">
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="mostrardetalle">
                <label class="form-check-label" for="mostrardetalle">Show detailed sales</label>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table
                        id="tablevendedores"
                        data-toggle="table"
                        data-url="./mods/facturacion/rptventasporempleado/procs/getvendedores.php"
