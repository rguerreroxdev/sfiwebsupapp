...
if (count($resulstadoBusqueda) > 0)
{
    ...
    $resultado["tipodegarantiaid"] = $resulstadoBusqueda[0]["TIPODEGARANTIAID"];
    $resultado["tipodegarantia"] = $resulstadoBusqueda[0]["TIPODEGARANTIA"];
}
else
{
    ...
    $resultado["msrp"] = "";
    $resultado["tipodegarantiaid"] = "";
    $resultado["tipodegarantia"] = "";
}
