...
array_push($data, [
    "<b>#</b>", "<b>Date</b>", "<b>Invoice #</b>", "<b>Customer name</b>", "<b>Product</b>", "<b>Price</b>", "<b>Platform</b>",
    "<b>Referral person</b>", "<b>Salesperson</b>"
]);
...
foreach($datos as $dato)
{
    ...
    array_push($data, [
        $conteo,
        str_replace("/", "-", $dato["FECHA"]), $dato["CORRELATIVO"], $dato["CLIENTENOMBRE"], $dato["PRODUCTO"], $dato["PRECIO"], $dato["PLATAFORMA"],
        $dato["PERSONADEREFERENCIA"], $dato["VENDEDOR"]
    ]);
}
