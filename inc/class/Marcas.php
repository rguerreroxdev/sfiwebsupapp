...
class Marcas
{
    ...
    /**
     * Obtener datos de un registro (INVMARCAS) por medio de ID
     * 
    ...
    public function getById(int $id): void
    {
        $sentenciaSql = "
            ...
            FROM
                INVMARCAS M
                JOIN ACCUSUARIOS UC ON UC.USUARIOID=M.USUARIOIDCREACION
                JOIN ACCUSUARIOS UM ON UM.USUARIOID=M.USUARIOIDMODIFICACION
            WHERE
                M.MARCAID = ?
        ";
    ...
    /**
     * Obtener todos los registros de la tabla (INVMARCAS) con paginación
     * 
    ...
    /**
     * Obtener registros de la tabla (INVMARCAS) con filtros
     * 
     * @param void
     * 
     * @return array Todos los registros encontrados en la tabla
    ...
    /**
     * Edita un registro (INVMARCAS) existente
     * 
    ...
    public function editarRegistro(int $id, array $camposValores): bool
    {
        ...
        $sentenciaSql = "
            UPDATE INVMARCAS SET " . $updates . " WHERE MARCAID = ?
        ";
    ...
    /**
     * Agregar un nuevo registro (INVMARCAS)
     * 
    ...
    public function agregarRegistro(string $nombre, int $usuarioId): bool
    {
        ...
        if ($agregado)
        {
            $this->marcaId = $datoResultado[0]["ID"];
        }
        else
        {
            $this->mensajeError = $this->conn->getMensajeError();
    ...
    /**
     * Eliminar un registro (INVMARCAS)
     * 
    ...
    public function eliminarRegistro(int $id): bool
    {
        ...
        $sentenciaSql = "
            DELETE FROM INVMARCAS WHERE MARCAID = ?
        ";
    ...
    /**
     * Obtener todos los registros de la tabla (INVMARCAS) para mostrar en combo
