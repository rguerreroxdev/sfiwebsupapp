<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "03.02.01.01");
    ...
    {   // Se cierra al final del archivo
        ...
        $listaDeSucursales = $objConfiguraciones->getListaDeSucursalesParaCombo();
        ...
        // Si no hay sucursales en la lista, marcar para retornar a listado
        $noConfiguracion = false;
        if (count($listaDeSucursales) == 1)
        {
            $noConfiguracion = true;
        }
?>

<h3>Invoice numbering and tax - Create new settings</h3>
        ...
        <div class="p-3 bg-body rounded shadow-sm">
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    ...
                    <span class="small text-secondary">Stores without settings are shown</span>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="prefijo" name="prefijo" class="form-control form-control-sm" maxlength="10" required>
                    </div>
                ...
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" id="siguientecorrelativo" name="siguientecorrelativo" class="form-control form-control-sm text-end" min="1" step="1" required>
                    </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" id="impuesto" name="impuesto" class="form-control form-control-sm text-end" step="0.01" min="0.00" max="99.99" required>
                    </div>
                </div>
            </div>
        </div>
...
<?php if ($noConfiguracion): ?>
<div class="modal fade small" id="modalNoConfig" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="staticBackdropLabel">Create new settings</h1>
            </div>
            <div class="modal-body">
                All stores already have settings.
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-sm" id="btnRetornarALista"><i class="bi bi-x-octagon"></i> Return to list</button>
            </div>
        </div>
    </div>
</div>
