<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("FAC", "03.01.05.01");
...
<h3>Services and other products - Create new</h3>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="descripcion" name="descripcion" class="form-control form-control-sm" maxlength="200" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="marcanombre" name="marcanombre" class="form-control form-control-sm" readonly>
                        <input type="hidden" id="marca" name="marca" class="form-control form-control-sm" readonly>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="modelo" name="modelo" class="form-control form-control-sm" maxlength="100">
                    </div>
                </div>
            </div>
