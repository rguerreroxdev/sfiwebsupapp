...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=colores";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=colores&subopc=editarcolor&cid=" + document.getElementById("cid").value;
});
...
function eliminar()
{
    ...
    fetch(
        "./mods/inventario/colores/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
