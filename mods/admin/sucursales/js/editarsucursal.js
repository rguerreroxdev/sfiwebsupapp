...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=admin&opc=sucursales&subopc=versucursal&sid=" + document.getElementById("sid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/admin/sucursales/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
...
function aplicarTrimAElementos()
{
    ...
    let telefonoServicio = document.getElementById("telefonoservicio");
    ...
    telefonoServicio.value = telefonoServicio.value.trim();
