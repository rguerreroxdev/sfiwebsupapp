...
document.getElementById("btnregresar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=plataformasref";
});

document.getElementById("btneditar").addEventListener("click", () => {
    window.location.href="?mod=facturacion&opc=plataformasref&subopc=editarplataforma&prid=" + document.getElementById("prid").value;
});
...
function eliminar()
{
    ...
    datos.append("prid", document.getElementById("prid").value);
    datos.append("uid", document.getElementById("uid").value);

    fetch(
        "./mods/facturacion/plataformasref/procs/eliminar.php",
        {
            method: "POST",
            body: datos
        }
