<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "03.02.01");
    ...
    {   // Se cierra al final del archivo
        ...
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("03.02.01");
        $accesoEditar = in_array("03.02.01.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("03.02.01.03", $accesos) ? "" : " disabled";
?>

<h3>Invoice numbering and tax - Settings detail</h3>
       ...
       <div class="p-3 bg-body rounded shadow-sm">
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Number prefix</span>
                        <input type="text" id="prefijo" name="prefijo" class="form-control form-control-sm" value="<?= $objConfiguracion->prefijoDeCorrelativo ?>" readonly>
                    </div>
                    <span class="small text-secondary">Prefix of the invoice number</span>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Next number</span>
                        <input type="number" id="siguientecorrelativo" name="siguientecorrelativo" class="form-control form-control-sm text-end" value="<?= $objConfiguracion->siguienteCorrelativo ?>" readonly>
                    </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Tax %</span>
                        <input type="number" id="impuesto" name="impuesto" class="form-control form-control-sm text-end" value="<?= $objConfiguracion->impuestosPorcentaje ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objConfiguracion->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objConfiguracion->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
