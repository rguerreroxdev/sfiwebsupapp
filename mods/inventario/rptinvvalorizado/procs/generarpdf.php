...
class PDF extends TCPDF
{
    ...
    function Header()
    {
        ...
        $this->SetXY(15, 20);	$this->Cell(0, 5, "VALUED INVENTORY", 0, 0, "C");
        ...
        $this->SetXY($x += 23, $y);     $this->Cell(25, 5, 'Color', 1, 0, '', false);
        $this->SetXY($x += 25, $y);     $this->Cell(45, 5, 'Description', 1, 0, '', false);
        $this->SetXY($x += 45, $y);     $this->Cell(12, 5, 'MSRP', 1, 0, '', false);
...
$datos = $objReportes->inventarioValorizado($usuarioId, $sucursalId, $categoriaId);
...
$anchoDeColumnas = [7, 25, 15, 28, 20, 23, 25, 45, 12, 15, 10, 10, 15];
...
$pdf->Cell(20, 5, "Total cost: ", 0, 0, "R");
$pdf->setXY($startX + 235, $currentY - 20);
$pdf->Cell(15, 5, "$ " . number_format($totalCosto, 2), 0, 0, "R");

//-----------------------------------------------

// Generar el PDF y enviarlo al navegador
$pdf->Output("Valued inventory.pdf");
