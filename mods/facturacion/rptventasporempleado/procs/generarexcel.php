...
$datos = $objReportes->ventasPorVendedorResumen($fechaInicial, $fechaFinal, $sucursalId, $usuarioVendedorId);
...
array_push($data, [
    "<b>#</b>", "<b>Salesperson</b>", "<b>Quantity of products</b>", "<b>Sum of sales</b>"
]);
