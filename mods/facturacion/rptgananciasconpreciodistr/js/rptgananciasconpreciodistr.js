...
function generarPdf()
{
    ...
    let url = mostrarDetalle ?
        `mods/facturacion/rptgananciasconpreciodistr/procs/generarpdfdetalle.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`
        :
        `mods/facturacion/rptgananciasconpreciodistr/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = mostrarDetalle ?
        `mods/facturacion/rptgananciasconpreciodistr/procs/generarexceldetalle.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`
        :
        `mods/facturacion/rptgananciasconpreciodistr/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
