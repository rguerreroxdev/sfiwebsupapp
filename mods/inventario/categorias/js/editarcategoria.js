...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=categorias&subopc=vercategoria&cid=" + document.getElementById("cid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/inventario/categorias/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
