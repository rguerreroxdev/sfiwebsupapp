...
array_push($data, ["<b>Sales taxes</b>"]);
...
array_push($data, [
    "<b>#</b>", "<b>Date</b>", "<b>Invoice #</b>", "<b>Form of payment</b>", "<b>Taxes to declare</b>", "<b>Financed taxes</b>"
]);
...
{
    $conteo++;
    $totalPorDeclarar += $dato["IMPUESTOPORDECLARAR"];
    $totalNoDeclarar += $dato["IMPUESTOSINDECLARAR"];
    ...
    array_push($data, [
        ...
        $dato["CORRELATIVO"],
        $dato["TIPODEPAGO"],
        number_format($dato["IMPUESTOPORDECLARAR"], 2, ".", ""),
        number_format($dato["IMPUESTOSINDECLARAR"], 2, ".", "")
    ]);
}
...
array_push($data, [
    ...
    "",
    "Total:",
    number_format($totalPorDeclarar, 2, ".", ""),
    number_format($totalNoDeclarar, 2, ".", "")
]);
...
$xlsx->downloadAs('Sales taxes.xlsx');