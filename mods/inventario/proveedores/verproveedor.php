<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.01.02");
    ...
    {   // Se cierra al final del archivo
        ...
        // Obtener los datos del proveedor recibido en la URL
        $proveedorId = -1;
        if (isset($_GET["pid"]))
        {
            $proveedorId = is_numeric($_GET["pid"]) ? intval($_GET["pid"]) : -1;
        }
        
        require_once("inc/class/Proveedores.php");
        $objProveedores = new Proveedores($conn);

        $objProveedores->getById($proveedorId);

        // Si el registro no existe, retornar a listado
        if ($objProveedores->proveedorId == -1)
        {
            echo ("<script>window.location.href='?mod=inventario&opc=proveedores'</script>");
            exit();
        }

        // Obtener accesos a opciones sobre registro
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("02.01.02");
        $accesoEditar = in_array("02.01.02.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("02.01.02.03", $accesos) ? "" : " disabled";
?>

<h3>Suppliers - Supplier data</h3>

<nav>
    <div class="nav nav-tabs small" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-editar-tab" data-bs-toggle="tab" data-bs-target="#nav-editar" type="button" role="tab" aria-controls="nav-editar" aria-selected="true">Supplier data</button>
            ...
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigo" name="codigo" class="form-control form-control-sm" value="<?= $objProveedores->codigo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-7 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" value="<?= $objProveedores->nombre ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-7 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" value="<?= $objProveedores->direccion ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" value="<?= $objProveedores->telefono ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objProveedores->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objProveedores->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objProveedores->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objProveedores->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>

        <input type="hidden" id="pid" name="pid" value="<?= $objProveedores->proveedorId ?>">
