...
function generarPdf()
{
    ...
    let url = `mods/facturacion/rptventasportipodepago/procs/generarpdf.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
...
function generarExcel()
{
    ...
    let url = `mods/facturacion/rptventasportipodepago/procs/generarexcel.php?u=${u}&s=${s}&fi=${fi}&ff=${ff}`;
    window.open(url, "_blank");
}
