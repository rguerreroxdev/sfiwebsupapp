<?php
    ...
    {   // Se cierra al final del archivo
        ...
        // Obtener los datos de la sucursal recibida en la URL
        $sucursalId = -1;
        if (isset($_GET["sid"]))
        {
            $sucursalId = is_numeric($_GET["sid"]) ? intval($_GET["sid"]) : -1;
        }
        ...
        $objSucursales->getById($sucursalId);

        // Si el registro no existe, retornar a listado
        if ($objSucursales->sucursalId == -1)
        {
            echo ("<script>window.location.href='?mod=admin&opc=sucursales'</script>");
            exit();
        }

        // Obtener accesos a opciones sobre registro
        $accesos = $usuarioAccesos->getListaDeOpcionesConAcceso("01.01.02");
        $accesoEditar = in_array("01.01.02.02", $accesos) ? "" : " disabled";
        $accesoEliminar = in_array("01.01.02.03", $accesos) ? "" : " disabled";
?>

<h3>Stores - Store data</h3>

<nav>
    <div class="nav nav-tabs small" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-editar-tab" data-bs-toggle="tab" data-bs-target="#nav-editar" type="button" role="tab" aria-controls="nav-editar" aria-selected="true">Store data</button>
    ...
    <div class="tab-pane fade show active" id="nav-editar" role="tabpanel" aria-labelledby="nav-editar-tab" tabindex="0">
        <div class="p-3 bg-body rounded shadow-sm">
            <div class="row">
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" value="<?= $objSucursales->nombre ?>" readonly>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-sm-5">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-130px">Is warehouse</span>
                        <div class="input-group-text">
                            <input type="checkbox" id="escasamatriz" name="escasamatriz" class="form-check-input mt-0" value=""<?= $objSucursales->esCasaMatriz == 1 ? " checked" : "" ?> disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" value="<?= $objSucursales->direccion ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="direccioncomplemento" name="direccioncomplemento" class="form-control form-control-sm" value="<?= $objSucursales->direccionComplemento ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="codigopostal" name="codigopostal" class="form-control form-control-sm" value="<?= $objSucursales->codigoPostal ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" value="<?= $objSucursales->telefono ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">Service phone number</span>
                        <input type="text" id="telefonoservicio" name="telefonoservicio" class="form-control form-control-sm" value="<?= $objSucursales->telefonoServicio ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechacreacion" name="fechacreacion" class="form-control form-control-sm" value="<?= $objSucursales->fechaCreacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who created</span>
                        <input type="text" id="usuariocreo" name="usuariocreo" class="form-control form-control-sm" value="<?= $objSucursales->usuarioCreo ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-sm-4">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="fechamodificacion" name="fechamodificacion" class="form-control form-control-sm" value="<?= $objSucursales->fechaModificacion->format("m/d/Y H:i") ?>" readonly>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-160px">User who modified</span>
                        <input type="text" id="usuariomodifico" name="usuariomodifico" class="form-control form-control-sm" value="<?= $objSucursales->usuarioModifica ?>" readonly>
                    </div>
                </div>
            </div>
        </div>

        <input type="hidden" id="sid" name="sid" value="<?= $objSucursales->sucursalId ?>">
