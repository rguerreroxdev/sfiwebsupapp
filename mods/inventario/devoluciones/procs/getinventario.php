...
$sucursalId = isset($_GET["sid"]) && trim($_GET["sid"]) != "" ? trim($_GET["sid"]) : -1;
...
$listaDeInventario = $objInventario->getInventarioEnSalidasPorSucursalConPaginacion($sucursalId, $categoriaId, $buscar, $numeroDePagina, $tamanoDePagina);
