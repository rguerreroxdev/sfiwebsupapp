<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("ADM", "01.01.01.01");
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control form-control-sm" maxlength="200" value="<?= $objEmpresa->nombre ?>" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-6">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="direccion" name="direccion" class="form-control form-control-sm" maxlength="200" value="<?= $objEmpresa->direccion ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-sm-4">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" id="telefono" name="telefono" class="form-control form-control-sm" maxlength="50" value="<?= $objEmpresa->telefono ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-3">
                        ...
                        <div class="text-center">
                            <img src="./imgs/QRCode.jpg" id="qractual" style="width: 100px;">
                        </div>
                        <div class="text-center">
                            <button type="button" class="btn btn-sm btn-primary" id="btnqr" style="min-width: 75px;"><i class="bi bi-card-image"></i> Change QR code image</button>
                        </div>
                    </div>
...
<div class="toast-container p-5 position-fixed top-0 start-50 translate-middle-x" id="toastPlacement">
    <div class="toast align-items-center text-white bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true" id="toastError">
        <div class="d-flex">
...
<div class="modal fade small" id="modalQR" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-danger" id="staticBackdropLabel">Select new QR code image</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col">
                        <div class="upload-area" id="upload-area">
                            <p id="upload-text">Drag image here or click to upload</p>
                            <img id="preview" src="" alt="Vista previa">
                            <input type="file" id="file-input" name="file" accept="image/jpeg" style="display:none;">
                        </div>
                    </div>
                    <div class="col small">
                        The image must be a JPG file with a maximum size of 1MB.<br><br><br>
                        <p id="alt-upload-text" style="display: none;">Drag another image into the area, or click on it if you need to change the current one.</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" id="btnguardarqr"><i class="bi bi-floppy2"></i> Upload and save image</button>
                <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
