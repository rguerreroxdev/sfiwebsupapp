...
document.getElementById("btncrear").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=devoluciones&subopc=registrodevolucion";
});
...
document.getElementById("tipodedevolucion").addEventListener("change", () => {
    actualizarTablaDeDatos();
});
...
document.getElementById("btnreset").addEventListener("click", () => {
    ...
    document.getElementById("tipodedevolucion").value = "-1";
...
function operateFormatter(value, row, index) {
    return [
        '<a href="javascript:verDatos(' + row.DEVOLUCIONID + ')" title="See">',
