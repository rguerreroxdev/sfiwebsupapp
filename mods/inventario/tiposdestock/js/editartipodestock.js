...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=tiposdestock&subopc=vertipodestock&tsid=" + document.getElementById("tsid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/inventario/tiposdestock/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
