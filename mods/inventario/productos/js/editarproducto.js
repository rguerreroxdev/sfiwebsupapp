...
document.getElementById("btncancelar").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=productos&subopc=verproducto&pid=" + document.getElementById("pid").value;
});
...
function guardar(datos)
{
    ...
    fetch(
        "./mods/inventario/productos/procs/guardaredit.php",
        {
            method: "POST",
            body: datos
        }
