...
$datos = $objReportes->ventasAgrupadasPorPlataforma($fechaInicial, $fechaFinal, $sucursalId);
...
array_push($data, ["<b>Sales by referral platform</b>"]);
...
$xlsx->downloadAs('Sales by referral platform.xlsx');