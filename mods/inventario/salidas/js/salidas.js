...
document.getElementById("btncrear").addEventListener("click", () => {
    window.location.href="?mod=inventario&opc=salidas&subopc=registrosalida";
});
...
document.getElementById("tipodesalida").addEventListener("change", () => {
    actualizarTablaDeDatos();
});
...
document.getElementById("btnreset").addEventListener("click", () => {
    ...
    document.getElementById("tipodesalida").value = "-1";
...
function operateFormatter(value, row, index) {
    return [
        '<a href="javascript:verDatos(' + row.SALIDAID + ')" title="See">',
