<?php
    ...
    $accesoAOpcion = $usuarioAccesos->validarAccesoAOpcionDeMenu("INV", "02.01.01.02");
    ...
    {   // Se cierra al final del archivo
        ...
        foreach ($listaDeCategorias as $categoria)
        {
            ...
            $selected = $objProductos->categoriaId == $valor ? " selected" : "";
            $listaDeCategoriasOptions .= "
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="marcanombre" name="marcanombre" class="form-control form-control-sm" value="<?= $objProductos->marca ?>" readonly required>
                        <input type="hidden" id="marca" name="marca" class="form-control form-control-sm" value="<?= $objProductos->marcaId ?>" readonly required>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="modelo" name="modelo" class="form-control form-control-sm" maxlength="100" value="<?= $objProductos->modelo ?>" required>
                    </div>
                </div>
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        <span class="input-group-text width-95px">Color<span class="text-danger">&nbsp;*</span></span>
                        <input type="text" id="colornombre" name="colornombre" class="form-control form-control-sm" value="<?= $objProductos->color ?>" readonly required>
                        <input type="hidden" id="color" name="color" class="form-control form-control-sm" value="<?= $objProductos->colorId ?>" readonly required>
            ...
            <div class="row mt-2">
                <div class="col-md-10 col-lg-6">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" id="descripcion" name="descripcion" class="form-control form-control-sm" maxlength="250" value="<?= $objProductos->descripcion ?>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-md-5 col-lg-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" id="msrp" name="msrp" class="form-control form-control-sm text-end" step="0.01" min="0.00" value="<?= $objProductos->msrp ?>" required>
                    </div>
                </div>
            </div>
        </div>
